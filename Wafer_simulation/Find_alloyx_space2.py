...
delta_E_limit = np.linspace(-0.01, 0.03, 5)
space = 0.05
...
diff_array = []
var1_name = 'alloy1_x'
limit = np.linspace(0.11, 0.31, 21)
isvarymodeln20 = 1
...
print("(Delta_E = {delta})Transmission probability of new wafer (REAL) is {x:.3e} ".format(x=prob_wafer_real, delta=delta_E))
